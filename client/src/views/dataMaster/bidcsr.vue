      ...
      <q-card-section class="main2 text-white">
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="text-h6 h_titleHead">Bidang CSR</div>
  ...
  export default {
    ...
    methods: {
      ...
      getView : function(){
        ...
        fetch(this.$store.state.url.URL_DM_BID + "view", {
            method: "POST",
            headers: {
      ...
      addData : function() {
        fetch(this.$store.state.url.URL_DM_BID + "addData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      editData : function(){
        fetch(this.$store.state.url.URL_DM_BID + "editData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      removeData : function(E){
        fetch(this.$store.state.url.URL_DM_BID + "removeData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
