      ...
      <q-card-section class="main2 text-white">
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="text-h6 h_titleHead">CSR Force Majeure (Kebencanaan)</div>
          ...
          <!-- =================================================== KONTENT =========================================================== -->
            <table width="100%">
              <tr class="h_table_head main1 text-white ">
                ...
                <th width="85%">Sub Force Majeure</th>
                    ...
                    <q-card-section class="q-pt-none">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-md-12 frame_cari">
                            <span class="h_lable ">Sub Force Majeure</span>
  ...
  export default {
    ...
    methods: {
      ...
      getView : function(){
        ...
        fetch(this.$store.state.url.URL_DM_BID + "viewForce", {
            method: "POST",
            headers: {
      ...
      addData : function() {
        fetch(this.$store.state.url.URL_DM_BID + "addDataForce", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
